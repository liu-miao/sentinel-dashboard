...
public class GatewayFlowRuleController {
    ...
    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(String app, String ip, Integer port) {
        ...
        try {
            Object obj = ruleProvider.getRules(app, NacosConfigUtil.GATEWAY_DATA_ID_POSTFIX);
            if (null == obj) {
                return Result.ofSuccess(null);
            }

            List<GatewayFlowRuleEntity> rules = JSON.parseArray(obj.toString(), GatewayFlowRuleEntity.class);
