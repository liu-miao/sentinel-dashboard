...
public class GatewayApiController {
    ...
    public Result<List<ApiDefinitionEntity>> queryApis(String app, String ip, Integer port) {
        ...
        try {
            Object obj = ruleProvider.getRules(app, NacosConfigUtil.API_DATA_ID_POSTFIX);
            if (null == obj) {
                return Result.ofSuccess(null);
            }
            List<ApiDefinitionEntity> apis = JSON.parseArray(obj.toString(), ApiDefinitionEntity.class);
    ...
    private boolean publishApis(String app, String ip, Integer port) {
        ...
        try {
            rulePublisher.publish(app,apis, NacosConfigUtil.API_DATA_ID_POSTFIX);
        } catch (Exception e) {
            e.printStackTrace();
