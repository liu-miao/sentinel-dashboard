...
public class AuthorityRuleController {
    ...
    private DynamicRuleProvider<Object> ruleProvider;
    @Autowired
    @Qualifier("ruleNacosPublisher")
    private DynamicRulePublisher<Object> rulePublisher;
    @Autowired
    ...
    public Result<List<AuthorityRuleEntity>> apiQueryAllRulesForMachine(@RequestParam String app,
        ...
        try {
            Object obj = ruleProvider.getRules(app, NacosConfigUtil.AUTHORITY_FLOW_DATA_ID_POSTFIX);
            if (null == obj) {
                return Result.ofSuccess(null);
            }
            List<AuthorityRuleEntity> rules = JSON.parseArray(obj.toString(), AuthorityRuleEntity.class);
    ...
    private boolean publishRules(String app, String ip, Integer port) {
        ...
        try {
            rulePublisher.publish(app,rules, NacosConfigUtil.AUTHORITY_FLOW_DATA_ID_POSTFIX);
        } catch (Exception e) {
            e.printStackTrace();
