...
public class SystemController {
    ...
    public Result<List<SystemRuleEntity>> apiQueryMachineRules(String app, String ip,
        ...
        try {
            Object obj = ruleProvider.getRules(app, NacosConfigUtil.SYSTEM_FLOW_DATA_ID_POSTFIX);
            if (null == obj) {
                return Result.ofSuccess(null);
            }
            List<SystemRuleEntity> rules = JSON.parseArray(obj.toString(), SystemRuleEntity.class);
    ...
    private boolean publishRules(String app, String ip, Integer port) {
        ...
        try {
            rulePublisher.publish(app,rules, NacosConfigUtil.SYSTEM_FLOW_DATA_ID_POSTFIX);
        } catch (Exception e) {
            e.printStackTrace();
