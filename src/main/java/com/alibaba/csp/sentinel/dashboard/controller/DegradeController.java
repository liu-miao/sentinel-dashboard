...
public class DegradeController {
    ...
    public Result<List<DegradeRuleEntity>> apiQueryMachineRules(String app, String ip, Integer port) {
        ...
        try {
            Object obj = ruleProvider.getRules(app, NacosConfigUtil.FLOW_DATA_ID_POSTFIX);
            if (null == obj) {
                return Result.ofSuccess(null);
            }
            List<DegradeRuleEntity> rules = JSON.parseArray(obj.toString(), DegradeRuleEntity.class);
    ...
    private boolean publishRules(String app, String ip, Integer port) {
        ...
        try {
            rulePublisher.publish(app,rules, NacosConfigUtil.DEGRADE_DATA_ID_POSTFIX);
        } catch (Exception e) {
            e.printStackTrace();
